...
async function fixture(){
 ...
 const contacts=createContacts({db,_:db.command,helpers:{getUserForAction:helpers.getUserForAction,conversationBlocked:helpers.conversationBlocked}})
 helpers.createContactGrant=contacts.grantForOpenids
 ...
 return {db,heart,contacts,users,blocked,deletedFiles,add,setTime:t=>clock=t,setReject:r=>reject=r}
}
