...
assert.ok(order.includes('deliveryCampuses') && order.includes('areaOptions') && order.includes('buildingOptions') && orderJs.includes('clientRequestId'), 'Order form uses configured structured address and idempotency')
