...
assert.ok(order.includes('deliveryCampuses') && order.includes('areaOptions') && order.includes('buildingOptions') && order.includes('服务尚未配置') && order.includes('服务配置加载失败') && orderJs.includes('clientRequestId'), 'Order form distinguishes service configuration states')
