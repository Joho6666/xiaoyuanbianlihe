...
Page({
  ...
  onHeartLike(e){const item=e&&e.detail&&e.detail.item;if(item)this.react({currentTarget:{dataset:{id:item.userId,action:'like'}}})},
  onHeartPass(e){const item=e&&e.detail&&e.detail.item;if(item)this.react({currentTarget:{dataset:{id:item.userId,action:'pass'}}})},
