...
const testFiles = [
  ...
  path.join(__dirname, '..', 'test', 'regression', 'ride-requests.test.js'),
  path.join(__dirname, '..', 'test', 'regression', 'ride-capacity.test.js'),
  path.join(__dirname, '..', 'test', 'regression', 'ride-security.test.js'),
  path.join(__dirname, '..', 'test', 'regression', 'ride-rate-limit.test.js'),
  path.join(__dirname, '..', 'test', 'regression', 'ride-public-privacy.test.js'),
  path.join(__dirname, '..', 'test', 'regression', 'ride-contact-auth.test.js'),
  path.join(__dirname, '..', 'test', 'regression', 'ride-report.test.js'),
  path.join(__dirname, '..', 'test', 'regression', 'ride-e2e.test.js'),
  path.join(__dirname, '..', 'test', 'regression', 'ride-action-contract.test.js'),
  ...
  path.join(__dirname, '..', 'test', 'regression', 'express-delivery-profile.test.js'),
  path.join(__dirname, '..', 'test', 'regression', 'express-multi-pickup.test.js'),
  path.join(__dirname, '..', 'test', 'regression', 'express-inline-delivery.test.js'),
  path.join(__dirname, '..', 'test', 'regression', 'express-multi-pickup-pricing.test.js'),
  path.join(__dirname, '..', 'test', 'regression', 'express-multi-pickup-export.test.js'),
  path.join(__dirname, '..', 'test', 'regression', 'express-multi-pickup-staff.test.js'),
  ...
  path.join(__dirname, '..', 'test', 'unit', 'ride-domain.test.js'),
  path.join(__dirname, '..', 'test', 'unit', 'ride-matching.test.js'),
